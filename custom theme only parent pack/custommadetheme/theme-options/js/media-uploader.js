(function($) {
    $(document).ready(function() {
        ...
        function custom_add_file(event, selector) {
            ...
            frame.on('select', function() {
                ...
                selector.find('.remove-image, .remove-file').on('click', function() {
                    custom_remove_file($(this).parents('.section'));
                });
            });
        ...
        function custom_remove_file(selector) {
            ...
            selector.find('.upload-button').on('click', function() { 
                custom_add_file(event, $(this).parents('.section'));
            });
        }
